...
urlpatterns = patterns("",
    url("^create%s$" % _slash, login_required(PresentationCreate.as_view()), name="presentation_create"),
    url("^list%s$" % _slash, PresentationList.as_view(), name="presentation_list"),
    url("^users/(?P<username>.*)%s$" % _slash, PresentationList.as_view(), name="presentation_list_author"),
